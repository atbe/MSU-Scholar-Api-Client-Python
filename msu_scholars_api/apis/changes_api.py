...
class ChangesApi(object):
    ...
    def get_changes(self, id_or_date, **kwargs):
        """
        Get changes
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_changes(id_or_date, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id_or_date: Id or date (in yyyy-MM-dd format) of the earliest audit entry (required)
        ...
        :return: WSChangeListResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_changes_with_http_info(id_or_date, **kwargs)
        else:
            (data) = self.get_changes_with_http_info(id_or_date, **kwargs)
            return data

    def get_changes_with_http_info(self, id_or_date, **kwargs):
        """
        Get changes
        Get changes from specific audit ID or date in the yyyy-MM-dd format (e.g. 2017-04-24) and forward
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_changes_with_http_info(id_or_date, callback=callback_function)
        ...
        all_params = ['id_or_date', 'q', 'order', 'fields', 'locale', 'fallback_locale', 'rendering', 'linking_strategy', 'return_used_content', 'navigation_link', 'size', 'offset', 'page', 'page_size']
        ...
        for key, val in iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id_or_date' is set
        ...
        path_params = {}
        if 'id_or_date' in params:
            path_params['idOrDate'] = params['id_or_date']
        ...
        return self.api_client.call_api('/changes/{idOrDate}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='WSChangeListResult',
