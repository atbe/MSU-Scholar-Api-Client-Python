...
class PublishersApi(object):
    ...
    def get_available_orderings_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/publishers-meta/orderings', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_available_renderings_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/publishers-meta/renderings', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_publisher(self, id, **kwargs):
        """
        Get publisher
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_publisher(id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: Id of the desired publisher (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_publisher_with_http_info(id, **kwargs)
        else:
            (data) = self.get_publisher_with_http_info(id, **kwargs)
            return data

    def get_publisher_with_http_info(self, id, **kwargs):
        """
        Get publisher
        Get the publisher with specific ID (path parameter).
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_publisher_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_publisher" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_publisher`")

        if 'id_classification' in params and not re.search('ID classification pattern', params['id_classification']):
            raise ValueError("Invalid value for parameter `id_classification` when calling `get_publisher`, must conform to the pattern `/ID classification pattern/`")
        if 'fields' in params and not re.search('Fields pattern', params['fields']):
            raise ValueError("Invalid value for parameter `fields` when calling `get_publisher`, must conform to the pattern `/Fields pattern/`")
        if 'locale' in params and not re.search('Locale pattern', params['locale']):
            raise ValueError("Invalid value for parameter `locale` when calling `get_publisher`, must conform to the pattern `/Locale pattern/`")
        if 'fallback_locale' in params and not re.search('Fallback locale pattern', params['fallback_locale']):
            raise ValueError("Invalid value for parameter `fallback_locale` when calling `get_publisher`, must conform to the pattern `/Fallback locale pattern/`")
        if 'rendering' in params and not re.search('Rendering pattern', params['rendering']):
            raise ValueError("Invalid value for parameter `rendering` when calling `get_publisher`, must conform to the pattern `/Rendering pattern/`")
        if 'return_used_content' in params and not re.search('ReturnUsedContent pattern', params['return_used_content']):
            raise ValueError("Invalid value for parameter `return_used_content` when calling `get_publisher`, must conform to the pattern `/ReturnUsedContent pattern/`")
        if 'navigation_link' in params and not re.search('NavigationLink pattern', params['navigation_link']):
            raise ValueError("Invalid value for parameter `navigation_link` when calling `get_publisher`, must conform to the pattern `/NavigationLink pattern/`")
        ...
        return self.api_client.call_api('/publishers/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_approved_publishers(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_approved_publishers(callback=callback_function)
        ...
        :return: WSPublishersListResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_approved_publishers_with_http_info(**kwargs)
        else:
            (data) = self.list_approved_publishers_with_http_info(**kwargs)
            return data

    def list_approved_publishers_with_http_info(self, **kwargs):
        """
        Get approved publishers
        Lists the publishers in the PURE installation which are in the 'approved' workflow step.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_approved_publishers_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_approved_publishers" % key
                )
            params[key] = val
        del params['kwargs']

        if 'q' in params and not re.search('Search pattern', params['q']):
            raise ValueError("Invalid value for parameter `q` when calling `list_approved_publishers`, must conform to the pattern `/Search pattern/`")
        if 'order' in params and not re.search('Order pattern', params['order']):
            raise ValueError("Invalid value for parameter `order` when calling `list_approved_publishers`, must conform to the pattern `/Order pattern/`")
        if 'fields' in params and not re.search('Fields pattern', params['fields']):
            raise ValueError("Invalid value for parameter `fields` when calling `list_approved_publishers`, must conform to the pattern `/Fields pattern/`")
        if 'locale' in params and not re.search('Locale pattern', params['locale']):
            raise ValueError("Invalid value for parameter `locale` when calling `list_approved_publishers`, must conform to the pattern `/Locale pattern/`")
        if 'fallback_locale' in params and not re.search('Fallback locale pattern', params['fallback_locale']):
            raise ValueError("Invalid value for parameter `fallback_locale` when calling `list_approved_publishers`, must conform to the pattern `/Fallback locale pattern/`")
        if 'rendering' in params and not re.search('Rendering pattern', params['rendering']):
            raise ValueError("Invalid value for parameter `rendering` when calling `list_approved_publishers`, must conform to the pattern `/Rendering pattern/`")
        if 'linking_strategy' in params and not re.search('Linkingstrategy pattern', params['linking_strategy']):
            raise ValueError("Invalid value for parameter `linking_strategy` when calling `list_approved_publishers`, must conform to the pattern `/Linkingstrategy pattern/`")
        if 'return_used_content' in params and not re.search('ReturnUsedContent pattern', params['return_used_content']):
            raise ValueError("Invalid value for parameter `return_used_content` when calling `list_approved_publishers`, must conform to the pattern `/ReturnUsedContent pattern/`")
        if 'navigation_link' in params and not re.search('NavigationLink pattern', params['navigation_link']):
            raise ValueError("Invalid value for parameter `navigation_link` when calling `list_approved_publishers`, must conform to the pattern `/NavigationLink pattern/`")
        if 'size' in params and not re.search('Size pattern', params['size']):
            raise ValueError("Invalid value for parameter `size` when calling `list_approved_publishers`, must conform to the pattern `/Size pattern/`")
        if 'offset' in params and not re.search('Offset pattern', params['offset']):
            raise ValueError("Invalid value for parameter `offset` when calling `list_approved_publishers`, must conform to the pattern `/Offset pattern/`")
        if 'page' in params and not re.search('Page pattern', params['page']):
            raise ValueError("Invalid value for parameter `page` when calling `list_approved_publishers`, must conform to the pattern `/Page pattern/`")
        if 'page_size' in params and not re.search('PageSize pattern', params['page_size']):
            raise ValueError("Invalid value for parameter `page_size` when calling `list_approved_publishers`, must conform to the pattern `/PageSize pattern/`")
        ...
        return self.api_client.call_api('/publishers/approved', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='WSPublishersListResult',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def list_publishers(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_publishers(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_publishers_with_http_info(**kwargs)
        else:
            (data) = self.list_publishers_with_http_info(**kwargs)
            return data

    def list_publishers_with_http_info(self, **kwargs):
        """
        Lists all publishers
        Lists all publishers in the PURE installation. If filtering is required for the the returned publishers, see the POST version which supports additional filtering.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_publishers_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_publishers" % key
                )
            params[key] = val
        del params['kwargs']

        if 'q' in params and not re.search('Search pattern', params['q']):
            raise ValueError("Invalid value for parameter `q` when calling `list_publishers`, must conform to the pattern `/Search pattern/`")
        if 'order' in params and not re.search('Order pattern', params['order']):
            raise ValueError("Invalid value for parameter `order` when calling `list_publishers`, must conform to the pattern `/Order pattern/`")
        if 'fields' in params and not re.search('Fields pattern', params['fields']):
            raise ValueError("Invalid value for parameter `fields` when calling `list_publishers`, must conform to the pattern `/Fields pattern/`")
        if 'locale' in params and not re.search('Locale pattern', params['locale']):
            raise ValueError("Invalid value for parameter `locale` when calling `list_publishers`, must conform to the pattern `/Locale pattern/`")
        if 'fallback_locale' in params and not re.search('Fallback locale pattern', params['fallback_locale']):
            raise ValueError("Invalid value for parameter `fallback_locale` when calling `list_publishers`, must conform to the pattern `/Fallback locale pattern/`")
        if 'rendering' in params and not re.search('Rendering pattern', params['rendering']):
            raise ValueError("Invalid value for parameter `rendering` when calling `list_publishers`, must conform to the pattern `/Rendering pattern/`")
        if 'linking_strategy' in params and not re.search('Linkingstrategy pattern', params['linking_strategy']):
            raise ValueError("Invalid value for parameter `linking_strategy` when calling `list_publishers`, must conform to the pattern `/Linkingstrategy pattern/`")
        if 'return_used_content' in params and not re.search('ReturnUsedContent pattern', params['return_used_content']):
            raise ValueError("Invalid value for parameter `return_used_content` when calling `list_publishers`, must conform to the pattern `/ReturnUsedContent pattern/`")
        if 'navigation_link' in params and not re.search('NavigationLink pattern', params['navigation_link']):
            raise ValueError("Invalid value for parameter `navigation_link` when calling `list_publishers`, must conform to the pattern `/NavigationLink pattern/`")
        if 'size' in params and not re.search('Size pattern', params['size']):
            raise ValueError("Invalid value for parameter `size` when calling `list_publishers`, must conform to the pattern `/Size pattern/`")
        if 'offset' in params and not re.search('Offset pattern', params['offset']):
            raise ValueError("Invalid value for parameter `offset` when calling `list_publishers`, must conform to the pattern `/Offset pattern/`")
        if 'page' in params and not re.search('Page pattern', params['page']):
            raise ValueError("Invalid value for parameter `page` when calling `list_publishers`, must conform to the pattern `/Page pattern/`")
        if 'page_size' in params and not re.search('PageSize pattern', params['page_size']):
            raise ValueError("Invalid value for parameter `page_size` when calling `list_publishers`, must conform to the pattern `/PageSize pattern/`")
        ...
        return self.api_client.call_api('/publishers', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_publishers_0(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_publishers_0(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param WSPublishersQuery body:
        :return: WSPublishersListResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_publishers_0_with_http_info(**kwargs)
        else:
            (data) = self.list_publishers_0_with_http_info(**kwargs)
            return data

    def list_publishers_0_with_http_info(self, **kwargs):
        """
        Complex operation for publishers
        Lists publishers in the PURE installation, similar to the GET version, instead of using parameters to alter the response, an XML document is posted with the request. The XML document contains fields for all the parameters available for the GET version, but also additional filtering options. For documentation of the XML format see <a href=\"documentation/Content/Topics/CT_Publisher.htm#post_xml\">Publisher documentation</a>
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_publishers_0_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_publishers_0" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/publishers', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
