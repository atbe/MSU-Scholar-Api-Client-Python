...
class WSAuthorCollaborationListResult(object):
    """
    ...
    swagger_types = {
        ...
        'items': 'list[WSAuthorCollaboration]'
    }
    ...
    def __init__(self, count=None, navigation_links=None, items=None):
        """
        WSAuthorCollaborationListResult - a model defined in Swagger
        """
    ...
    def count(self):
        """
        Gets the count of this WSAuthorCollaborationListResult.

        :return: The count of this WSAuthorCollaborationListResult.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """
        Sets the count of this WSAuthorCollaborationListResult.

        :param count: The count of this WSAuthorCollaborationListResult.
        :type: int
        """
    ...
    def navigation_links(self):
        """
        Gets the navigation_links of this WSAuthorCollaborationListResult.

        :return: The navigation_links of this WSAuthorCollaborationListResult.
    ...
    def navigation_links(self, navigation_links):
        """
        Sets the navigation_links of this WSAuthorCollaborationListResult.

        :param navigation_links: The navigation_links of this WSAuthorCollaborationListResult.
    ...
    def items(self):
        """
        Gets the items of this WSAuthorCollaborationListResult.

        :return: The items of this WSAuthorCollaborationListResult.
        :rtype: list[WSAuthorCollaboration]
        """
        return self._items
    ...
    def items(self, items):
        """
        Sets the items of this WSAuthorCollaborationListResult.

        :param items: The items of this WSAuthorCollaborationListResult.
        :type: list[WSAuthorCollaboration]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, WSAuthorCollaborationListResult):
            return False
