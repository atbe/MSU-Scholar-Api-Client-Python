...
from msu_scholars_api.models.ws_keyword_propagation_configuration import WSKeywordPropagationConfiguration


class TestWSKeywordPropagationConfiguration(unittest.TestCase):
    """ WSKeywordPropagationConfiguration unit test stubs """
    ...
    def testWSKeywordPropagationConfiguration(self):
        """
        Test WSKeywordPropagationConfiguration
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_keyword_propagation_configuration.WSKeywordPropagationConfiguration()
        pass
