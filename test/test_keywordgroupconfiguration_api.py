...
from msu_scholars_api.apis.keywordgroupconfiguration_api import KeywordgroupconfigurationApi


class TestKeywordgroupconfigurationApi(unittest.TestCase):
    """ KeywordgroupconfigurationApi unit test stubs """

    def setUp(self):
        self.api = msu_scholars_api.apis.keywordgroupconfiguration_api.KeywordgroupconfigurationApi()
    ...
    def test_get_keyword_group_configuration(self):
        """
        Test case for get_keyword_group_configuration

        Get KeywordGroupConfiguration
        """
        pass

    def test_list_keyword_group_configurations(self):
        """
        Test case for list_keyword_group_configurations

        Lists all keyword group configurations
        """
        pass

    def test_list_keyword_group_configurations_0(self):
        """
        Test case for list_keyword_group_configurations_0
