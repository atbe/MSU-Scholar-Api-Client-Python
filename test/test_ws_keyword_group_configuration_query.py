...
from msu_scholars_api.models.ws_keyword_group_configuration_query import WSKeywordGroupConfigurationQuery


class TestWSKeywordGroupConfigurationQuery(unittest.TestCase):
    """ WSKeywordGroupConfigurationQuery unit test stubs """
    ...
    def testWSKeywordGroupConfigurationQuery(self):
        """
        Test WSKeywordGroupConfigurationQuery
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_keyword_group_configuration_query.WSKeywordGroupConfigurationQuery()
        pass
