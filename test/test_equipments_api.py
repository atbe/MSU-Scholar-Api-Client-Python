...
from msu_scholars_api.apis.equipments_api import EquipmentsApi


class TestEquipmentsApi(unittest.TestCase):
    """ EquipmentsApi unit test stubs """

    def setUp(self):
        self.api = msu_scholars_api.apis.equipments_api.EquipmentsApi()
    ...
    def test_list_equipment_0(self):
        """
        Test case for list_equipment_0

        Complex operation for equipment
        """
        pass

    def test_list_equipment_fingerprints(self):
        """
        Test case for list_equipment_fingerprints
