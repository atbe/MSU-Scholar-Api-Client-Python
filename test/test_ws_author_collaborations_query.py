...
from msu_scholars_api.models.ws_author_collaborations_query import WSAuthorCollaborationsQuery


class TestWSAuthorCollaborationsQuery(unittest.TestCase):
    """ WSAuthorCollaborationsQuery unit test stubs """
    ...
    def testWSAuthorCollaborationsQuery(self):
        """
        Test WSAuthorCollaborationsQuery
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_author_collaborations_query.WSAuthorCollaborationsQuery()
        pass
