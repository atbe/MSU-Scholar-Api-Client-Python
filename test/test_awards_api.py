...
from msu_scholars_api.apis.awards_api import AwardsApi
...
class TestAwardsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = msu_scholars_api.apis.awards_api.AwardsApi()
    ...
    def test_list_award_fingerprints(self):
        """
        Test case for list_award_fingerprints
    ...
    def test_list_awards(self):
        """
        Test case for list_awards

        Lists all awards
        """
        pass

    def test_list_awards_0(self):
        """
        Test case for list_awards_0
