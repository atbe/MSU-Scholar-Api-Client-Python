...
from msu_scholars_api.models.ws_author_collaboration_list_result import WSAuthorCollaborationListResult


class TestWSAuthorCollaborationListResult(unittest.TestCase):
    """ WSAuthorCollaborationListResult unit test stubs """
    ...
    def testWSAuthorCollaborationListResult(self):
        """
        Test WSAuthorCollaborationListResult
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_author_collaboration_list_result.WSAuthorCollaborationListResult()
        pass
