...
from msu_scholars_api.models.ws_keyword_group_configuration import WSKeywordGroupConfiguration


class TestWSKeywordGroupConfiguration(unittest.TestCase):
    """ WSKeywordGroupConfiguration unit test stubs """
    ...
    def testWSKeywordGroupConfiguration(self):
        """
        Test WSKeywordGroupConfiguration
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_keyword_group_configuration.WSKeywordGroupConfiguration()
        pass
