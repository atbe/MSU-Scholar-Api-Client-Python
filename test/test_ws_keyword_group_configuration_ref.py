...
from msu_scholars_api.models.ws_keyword_group_configuration_ref import WSKeywordGroupConfigurationRef


class TestWSKeywordGroupConfigurationRef(unittest.TestCase):
    """ WSKeywordGroupConfigurationRef unit test stubs """
    ...
    def testWSKeywordGroupConfigurationRef(self):
        """
        Test WSKeywordGroupConfigurationRef
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_keyword_group_configuration_ref.WSKeywordGroupConfigurationRef()
        pass
