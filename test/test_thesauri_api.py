...
from msu_scholars_api.apis.thesauri_api import ThesauriApi


class TestThesauriApi(unittest.TestCase):
    """ ThesauriApi unit test stubs """

    def setUp(self):
        self.api = msu_scholars_api.apis.thesauri_api.ThesauriApi()
    ...
    def test_get_thesauri(self):
        """
        Test case for get_thesauri
