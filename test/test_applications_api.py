...
from msu_scholars_api.apis.applications_api import ApplicationsApi
...
class TestApplicationsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = msu_scholars_api.apis.applications_api.ApplicationsApi()
    ...
    def test_list_applications_0(self):
        """
        Test case for list_applications_0
