...
from msu_scholars_api.apis.publishers_api import PublishersApi
...
class TestPublishersApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = msu_scholars_api.apis.publishers_api.PublishersApi()
    ...
    def test_list_approved_publishers(self):
        """
        Test case for list_approved_publishers
    ...
    def test_list_publishers(self):
        """
        Test case for list_publishers

        Lists all publishers
        """
        pass

    def test_list_publishers_0(self):
        """
        Test case for list_publishers_0
