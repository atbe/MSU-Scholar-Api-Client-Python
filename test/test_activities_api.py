...
from msu_scholars_api.apis.activities_api import ActivitiesApi
...
class TestActivitiesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = msu_scholars_api.apis.activities_api.ActivitiesApi()
    ...
    def test_list_activities_0(self):
        """
        Test case for list_activities_0
