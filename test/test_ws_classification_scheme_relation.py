...
from msu_scholars_api.models.ws_classification_scheme_relation import WSClassificationSchemeRelation


class TestWSClassificationSchemeRelation(unittest.TestCase):
    """ WSClassificationSchemeRelation unit test stubs """
    ...
    def testWSClassificationSchemeRelation(self):
        """
        Test WSClassificationSchemeRelation
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_classification_scheme_relation.WSClassificationSchemeRelation()
        pass
