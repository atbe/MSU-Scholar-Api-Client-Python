...
from msu_scholars_api.models.ws_keyword_group_configuration_list_result import WSKeywordGroupConfigurationListResult


class TestWSKeywordGroupConfigurationListResult(unittest.TestCase):
    """ WSKeywordGroupConfigurationListResult unit test stubs """
    ...
    def testWSKeywordGroupConfigurationListResult(self):
        """
        Test WSKeywordGroupConfigurationListResult
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = msu_scholars_api.models.ws_keyword_group_configuration_list_result.WSKeywordGroupConfigurationListResult()
        pass
