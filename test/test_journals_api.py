...
from msu_scholars_api.apis.journals_api import JournalsApi
...
class TestJournalsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = msu_scholars_api.apis.journals_api.JournalsApi()
    ...
    def test_list_journals_0(self):
        """
        Test case for list_journals_0
