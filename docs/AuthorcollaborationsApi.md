# msu_scholars_api.AuthorcollaborationsApi

All URIs are relative to *https://scholars.opb.msu.edu/ws/api/511*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_author_collaboration**](AuthorcollaborationsApi.md#get_author_collaboration) | **GET** /author-collaborations/{id} | Get author collaboration
[**get_available_orderings**](AuthorcollaborationsApi.md#get_available_orderings) | **GET** /author-collaborations-meta/orderings | Lists available orderings
[**get_available_renderings**](AuthorcollaborationsApi.md#get_available_renderings) | **GET** /author-collaborations-meta/renderings | Lists available renderings
[**list_author_collaborations**](AuthorcollaborationsApi.md#list_author_collaborations) | **GET** /author-collaborations | Lists all author collaborations
[**list_author_collaborations_0**](AuthorcollaborationsApi.md#list_author_collaborations_0) | **POST** /author-collaborations | Complex operation for author collaborations


# **get_author_collaboration**
> WSAuthorCollaboration get_author_collaboration(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)

Get author collaboration

Get author collaboration with specific ID (path parameter).
...
api_instance = msu_scholars_api.AuthorcollaborationsApi()
id = 'id_example' # str | Id of the desired author collaboration
...
try: 
    # Get author collaboration
    api_response = api_instance.get_author_collaboration(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AuthorcollaborationsApi->get_author_collaboration: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired author collaboration | 
...
[**WSAuthorCollaboration**](WSAuthorCollaboration.md)
...
Lists all orderings available to the author collaboration endpoint. These values can be used by the order parameter
...
try: 
    ...
    print("Exception when calling AuthorcollaborationsApi->get_available_orderings: %s\n" % e)
```
...
Lists all renderings available to the author collaboration endpoint. These values can be used by the rendering parameter
...
try: 
    ...
    print("Exception when calling AuthorcollaborationsApi->get_available_renderings: %s\n" % e)
```
...
try: 
    # Lists all author collaborations
    api_response = api_instance.list_author_collaborations(q=q, fields=fields, order=order, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AuthorcollaborationsApi->list_author_collaborations: %s\n" % e)
```
...
[**WSAuthorCollaborationListResult**](WSAuthorCollaborationListResult.md)
...
# create an instance of the API class
api_instance = msu_scholars_api.AuthorcollaborationsApi()
body = msu_scholars_api.WSAuthorCollaborationsQuery() # WSAuthorCollaborationsQuery |  (optional)

try: 
    # Complex operation for author collaborations
    api_response = api_instance.list_author_collaborations_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AuthorcollaborationsApi->list_author_collaborations_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSAuthorCollaborationsQuery**](WSAuthorCollaborationsQuery.md)|  | [optional] 
