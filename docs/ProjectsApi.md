# msu_scholars_api.ProjectsApi

All URIs are relative to *https://localhosthttps://scholars.opb.msu.edu/ws/api/510/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_available_orderings**](ProjectsApi.md#get_available_orderings) | **GET** /projects-meta/orderings | Lists available orderings
[**get_available_renderings**](ProjectsApi.md#get_available_renderings) | **GET** /projects-meta/renderings | Lists available renderings
[**get_project**](ProjectsApi.md#get_project) | **GET** /projects/{id} | Get project
[**list_active_projects**](ProjectsApi.md#list_active_projects) | **GET** /projects/active | Lists all active projects
[**list_project_fingerprints**](ProjectsApi.md#list_project_fingerprints) | **GET** /projects/{id}/fingerprints | Lists fingerprints on a project
[**list_projects**](ProjectsApi.md#list_projects) | **GET** /projects | Lists all projects
[**list_projects_0**](ProjectsApi.md#list_projects_0) | **POST** /projects | Complex operation for projects
...
api_instance = msu_scholars_api.ProjectsApi()
...
try: 
    ...
    print("Exception when calling ProjectsApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling ProjectsApi->get_available_renderings: %s\n" % e)
```
...
# **get_project**
> WSUPMProject get_project(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
# create an instance of the API class
api_instance = msu_scholars_api.ProjectsApi()
id = 'id_example' # str | Id of the desired project
...
try: 
    # Get project
    api_response = api_instance.get_project(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired project | 
...
> WSUPMProjectListResult list_active_projects(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
# **list_project_fingerprints**
> WSFingerprintListResult list_project_fingerprints(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
try: 
    # Lists fingerprints on a project
    api_response = api_instance.list_project_fingerprints(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProjectsApi->list_project_fingerprints: %s\n" % e)
```
...
# **list_projects**
> WSUPMProjectListResult list_projects(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all projects
    api_response = api_instance.list_projects(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
# **list_projects_0**
> WSUPMProjectListResult list_projects_0(body=body)
...
# create an instance of the API class
api_instance = msu_scholars_api.ProjectsApi()
body = msu_scholars_api.WSUPMProjectsQuery() # WSUPMProjectsQuery |  (optional)

try: 
    # Complex operation for projects
    api_response = api_instance.list_projects_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProjectsApi->list_projects_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSUPMProjectsQuery**](WSUPMProjectsQuery.md)|  | [optional] 
