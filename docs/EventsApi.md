# msu_scholars_api.EventsApi

All URIs are relative to *https://localhosthttps://scholars.opb.msu.edu/ws/api/510/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_available_orderings**](EventsApi.md#get_available_orderings) | **GET** /events-meta/orderings | Lists available orderings
[**get_available_renderings**](EventsApi.md#get_available_renderings) | **GET** /events-meta/renderings | Lists available renderings
[**get_event**](EventsApi.md#get_event) | **GET** /events/{id} | Get event
[**list_events**](EventsApi.md#list_events) | **GET** /events | Lists all events
[**list_events_0**](EventsApi.md#list_events_0) | **POST** /events | Complex operation for events
...
api_instance = msu_scholars_api.EventsApi()
...
try: 
    ...
    print("Exception when calling EventsApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling EventsApi->get_available_renderings: %s\n" % e)
```
...
# **get_event**
> WSEvent get_event(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
# create an instance of the API class
api_instance = msu_scholars_api.EventsApi()
id = 'id_example' # str | Id of the desired event
...
try: 
    # Get event
    api_response = api_instance.get_event(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired event | 
...
# **list_events**
> WSEventListResult list_events(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all events
    api_response = api_instance.list_events(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
[**WSEventListResult**](WSEventListResult.md)
...
# **list_events_0**
> WSEventListResult list_events_0(body=body)

Complex operation for events
...
# create an instance of the API class
api_instance = msu_scholars_api.EventsApi()
body = msu_scholars_api.WSEventsQuery() # WSEventsQuery |  (optional)

try: 
    # Complex operation for events
    api_response = api_instance.list_events_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling EventsApi->list_events_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSEventsQuery**](WSEventsQuery.md)|  | [optional] 
