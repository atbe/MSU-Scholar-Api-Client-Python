# msu_scholars_api.ApplicationsApi

All URIs are relative to *https://scholars.opb.msu.edu/ws/api/510*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_application**](ApplicationsApi.md#get_application) | **GET** /applications/{id} | Get application
[**get_available_orderings**](ApplicationsApi.md#get_available_orderings) | **GET** /applications-meta/orderings | Lists available orderings
[**get_available_renderings**](ApplicationsApi.md#get_available_renderings) | **GET** /applications-meta/renderings | Lists available renderings
[**list_applications**](ApplicationsApi.md#list_applications) | **GET** /applications | Lists all applications
[**list_applications_0**](ApplicationsApi.md#list_applications_0) | **POST** /applications | Complex operation for applications


# **get_application**
> WSApplication get_application(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
api_instance = msu_scholars_api.ApplicationsApi()
id = 'id_example' # str | Id of the desired application
...
try: 
    # Get application
    api_response = api_instance.get_application(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired application | 
...
try: 
    ...
    print("Exception when calling ApplicationsApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling ApplicationsApi->get_available_renderings: %s\n" % e)
```
...
# **list_applications**
> WSApplicationListResult list_applications(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all applications
    api_response = api_instance.list_applications(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
# **list_applications_0**
> WSApplicationListResult list_applications_0(body=body)

Complex operation for applications
...
# create an instance of the API class
api_instance = msu_scholars_api.ApplicationsApi()
body = msu_scholars_api.WSApplicationsQuery() # WSApplicationsQuery |  (optional)

try: 
    # Complex operation for applications
    api_response = api_instance.list_applications_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ApplicationsApi->list_applications_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSApplicationsQuery**](WSApplicationsQuery.md)|  | [optional] 
