# msu_scholars_api.PrizesApi

All URIs are relative to *https://localhosthttps://scholars.opb.msu.edu/ws/api/510/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_available_orderings**](PrizesApi.md#get_available_orderings) | **GET** /prizes-meta/orderings | Lists available orderings
[**get_available_renderings**](PrizesApi.md#get_available_renderings) | **GET** /prizes-meta/renderings | Lists available renderings
[**get_prize**](PrizesApi.md#get_prize) | **GET** /prizes/{id} | Get prize
[**list_prizes**](PrizesApi.md#list_prizes) | **GET** /prizes | Lists all prizes
[**list_prizes_0**](PrizesApi.md#list_prizes_0) | **POST** /prizes | Complex operation for prizes
...
api_instance = msu_scholars_api.PrizesApi()
...
try: 
    ...
    print("Exception when calling PrizesApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling PrizesApi->get_available_renderings: %s\n" % e)
```
...
# **get_prize**
> WSPrize get_prize(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
try: 
    # Get prize
    api_response = api_instance.get_prize(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PrizesApi->get_prize: %s\n" % e)
```
...
# **list_prizes**
> WSPrizeListResult list_prizes(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all prizes
    api_response = api_instance.list_prizes(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PrizesApi->list_prizes: %s\n" % e)
```
...
# **list_prizes_0**
> WSPrizeListResult list_prizes_0(body=body)
...
# create an instance of the API class
api_instance = msu_scholars_api.PrizesApi()
body = msu_scholars_api.WSPrizesQuery() # WSPrizesQuery |  (optional)

try: 
    # Complex operation for prizes
    api_response = api_instance.list_prizes_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PrizesApi->list_prizes_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSPrizesQuery**](WSPrizesQuery.md)|  | [optional] 
