# msu_scholars_api.PressmediaApi

All URIs are relative to *https://localhosthttps://scholars.opb.msu.edu/ws/api/510/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_available_orderings**](PressmediaApi.md#get_available_orderings) | **GET** /press-media-meta/orderings | Lists available orderings
[**get_available_renderings**](PressmediaApi.md#get_available_renderings) | **GET** /press-media-meta/renderings | Lists available renderings
[**get_press_media**](PressmediaApi.md#get_press_media) | **GET** /press-media/{id} | Get press / media
[**list_press_media**](PressmediaApi.md#list_press_media) | **GET** /press-media | Lists all press / media
[**list_press_media_0**](PressmediaApi.md#list_press_media_0) | **POST** /press-media | Complex operation for press / media
...
api_instance = msu_scholars_api.PressmediaApi()
...
try: 
    ...
    print("Exception when calling PressmediaApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling PressmediaApi->get_available_renderings: %s\n" % e)
```
...
# **get_press_media**
> WSApplication get_press_media(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
# create an instance of the API class
api_instance = msu_scholars_api.PressmediaApi()
id = 'id_example' # str | Id of the desired press / media
...
try: 
    # Get press / media
    api_response = api_instance.get_press_media(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PressmediaApi->get_press_media: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired press / media | 
...
[**WSApplication**](WSApplication.md)
...
# **list_press_media**
> WSPressMediaListResult list_press_media(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all press / media
    api_response = api_instance.list_press_media(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PressmediaApi->list_press_media: %s\n" % e)
```
...
# **list_press_media_0**
> WSPressMediaListResult list_press_media_0(body=body)
...
# create an instance of the API class
api_instance = msu_scholars_api.PressmediaApi()
body = msu_scholars_api.WSPressMediaQuery() # WSPressMediaQuery |  (optional)

try: 
    # Complex operation for press / media
    api_response = api_instance.list_press_media_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PressmediaApi->list_press_media_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSPressMediaQuery**](WSPressMediaQuery.md)|  | [optional] 
