...
------------- | ------------- | -------------
[**get_available_orderings**](ThesauriApi.md#get_available_orderings) | **GET** /thesauri-meta/orderings | Lists available orderings
[**get_available_renderings**](ThesauriApi.md#get_available_renderings) | **GET** /thesauri-meta/renderings | Lists available renderings
[**get_thesauri**](ThesauriApi.md#get_thesauri) | **GET** /thesauri/{id} | Get thesauri
[**list_thesauri**](ThesauriApi.md#list_thesauri) | **GET** /thesauri | Lists all thesauri
...
api_instance = msu_scholars_api.ThesauriApi()
...
try: 
    ...
    print("Exception when calling ThesauriApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling ThesauriApi->get_available_renderings: %s\n" % e)
```
...
# **get_thesauri**
> WSThesauri get_thesauri(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
# create an instance of the API class
api_instance = msu_scholars_api.ThesauriApi()
id = 'id_example' # str | Id of the desired thesauri
...
try: 
    # Get thesauri
    api_response = api_instance.get_thesauri(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ThesauriApi->get_thesauri: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired thesauri | 
...
# **list_thesauri**
> WSThesauriListResult list_thesauri(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all thesauri
    api_response = api_instance.list_thesauri(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ThesauriApi->list_thesauri: %s\n" % e)
```
...
[**WSThesauriListResult**](WSThesauriListResult.md)
