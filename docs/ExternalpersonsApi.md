# msu_scholars_api.ExternalpersonsApi

All URIs are relative to *https://localhosthttps://scholars.opb.msu.edu/ws/api/510/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_available_orderings**](ExternalpersonsApi.md#get_available_orderings) | **GET** /external-persons-meta/orderings | Lists available orderings
[**get_available_renderings**](ExternalpersonsApi.md#get_available_renderings) | **GET** /external-persons-meta/renderings | Lists available renderings
[**get_external_person**](ExternalpersonsApi.md#get_external_person) | **GET** /external-persons/{id} | Get external person
[**list_external_persons**](ExternalpersonsApi.md#list_external_persons) | **GET** /external-persons | Lists all external persons
[**list_external_persons_0**](ExternalpersonsApi.md#list_external_persons_0) | **POST** /external-persons | Complex operation for external persons
...
api_instance = msu_scholars_api.ExternalpersonsApi()
...
try: 
    ...
    print("Exception when calling ExternalpersonsApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling ExternalpersonsApi->get_available_renderings: %s\n" % e)
```
...
# **get_external_person**
> WSExternalPerson get_external_person(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
# create an instance of the API class
api_instance = msu_scholars_api.ExternalpersonsApi()
id = 'id_example' # str | Id of the desired external person
...
try: 
    # Get external person
    api_response = api_instance.get_external_person(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ExternalpersonsApi->get_external_person: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired external person | 
...
[**WSExternalPerson**](WSExternalPerson.md)
...
try: 
    # Lists all external persons
    api_response = api_instance.list_external_persons(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ExternalpersonsApi->list_external_persons: %s\n" % e)
```
...
[**WSExternalPersonListResult**](WSExternalPersonListResult.md)
...
# **list_external_persons_0**
> WSExternalPersonListResult list_external_persons_0(body=body)

Complex operation for external persons
...
# create an instance of the API class
api_instance = msu_scholars_api.ExternalpersonsApi()
body = msu_scholars_api.WSExternalPersonsQuery() # WSExternalPersonsQuery |  (optional)

try: 
    # Complex operation for external persons
    api_response = api_instance.list_external_persons_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ExternalpersonsApi->list_external_persons_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSExternalPersonsQuery**](WSExternalPersonsQuery.md)|  | [optional] 
