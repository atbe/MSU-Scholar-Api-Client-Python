# msu_scholars_api.ActivitiesApi

All URIs are relative to *https://localhosthttps://scholars.opb.msu.edu/ws/api/510/*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_activity**](ActivitiesApi.md#get_activity) | **GET** /activities/{id} | Get activity
[**get_available_orderings**](ActivitiesApi.md#get_available_orderings) | **GET** /activities-meta/orderings | Lists available orderings
[**get_available_renderings**](ActivitiesApi.md#get_available_renderings) | **GET** /activities-meta/renderings | Lists available renderings
[**list_activities**](ActivitiesApi.md#list_activities) | **GET** /activities | Lists all activities
[**list_activities_0**](ActivitiesApi.md#list_activities_0) | **POST** /activities | Complex operation for activities


# **get_activity**
> WSAbstractActivity get_activity(id, id_classification=id_classification, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, return_used_content=return_used_content, navigation_link=navigation_link)
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Id of the desired activity | 
...
[**WSAbstractActivity**](WSAbstractActivity.md)
...
try: 
    ...
    print("Exception when calling ActivitiesApi->get_available_orderings: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling ActivitiesApi->get_available_renderings: %s\n" % e)
```
...
# **list_activities**
> WSActivityListResult list_activities(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
...
try: 
    # Lists all activities
    api_response = api_instance.list_activities(q=q, order=order, fields=fields, locale=locale, fallback_locale=fallback_locale, rendering=rendering, linking_strategy=linking_strategy, return_used_content=return_used_content, navigation_link=navigation_link, size=size, offset=offset, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
# **list_activities_0**
> WSActivityListResult list_activities_0(body=body)

Complex operation for activities
...
# create an instance of the API class
api_instance = msu_scholars_api.ActivitiesApi()
body = msu_scholars_api.WSActivityQuery() # WSActivityQuery |  (optional)

try: 
    # Complex operation for activities
    api_response = api_instance.list_activities_0(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ActivitiesApi->list_activities_0: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WSActivityQuery**](WSActivityQuery.md)|  | [optional] 
